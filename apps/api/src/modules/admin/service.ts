...
export async function getGuildRuntimeSettings(): Promise<GuildRuntimeSettings> {
  ...
  return {
    ...
    autoMentionStatusEnabled: settings.autoMentionStatusEnabled,
    mentionStatusCooldownMinutes: settings.mentionStatusCooldownMinutes,
    activityActiveMinutes: settings.activityActiveMinutes,
    mentionStatusChannelIds: settings.mentionStatusChannelIds,
    mentionStatusExcludedIds: settings.mentionStatusExcludedIds,
    activityTrackingEnabled: settings.activityTrackingEnabled,
    availabilityLfgIntegration: settings.availabilityLfgIntegration,
  };
}
  ...
  await db.$transaction([
    ...
    db.guildSettings.upsert({
      ...
      update: {
        ...
        autoMentionStatusEnabled: input.autoMentionStatusEnabled,
        mentionStatusCooldownMinutes: input.mentionStatusCooldownMinutes,
        activityActiveMinutes: input.activityActiveMinutes,
        mentionStatusChannelIds: input.mentionStatusChannelIds,
        mentionStatusExcludedIds: input.mentionStatusExcludedIds,
        activityTrackingEnabled: input.activityTrackingEnabled,
        availabilityLfgIntegration: input.availabilityLfgIntegration,
        updatedBy: adminId,
      },
      create: {
        guildId,
