(() => {
  const entries = [
    ['fun','الترفيه','قصف جبهات','/zark-noob','اطلب قصف جبهتك بمزحة عربية من 30 ردًا عن الألعاب، مع تنويع الردود.'],
    ...
    ['fun','الترفيه','نكتة داخل صورة','/نكت','كل 4,455 نكتة مصنّفة فكاهية من مكتبة Arabic-Humor، داخل بطاقة مع منع التكرار.'],
    ['fun','الترفيه','ميمز عربية','/ميمز','1,957 ميم عربي مصنّف فكاهيًا وغير كاره وغير دعائي، مع منع التكرار.'],
    ['rooms','الغرف','أنشئ غرفة','/lfg create','حدد اللعبة واجمع فريقًا يناسبك؛ أجهزتها مصنفة مسبقًا.'],
    ...
    ['rooms','الغرف','اهتماماتي','/lfg interests','حدد الألعاب التي تريد استقبال دعواتها.'],
    ['rooms','الفرق','إدارة فريقي','/team','أنشئ فريقاً، اعرض التشكيلة، ادعُ اللاعبين واقبل الدعوات من Discord.'],
